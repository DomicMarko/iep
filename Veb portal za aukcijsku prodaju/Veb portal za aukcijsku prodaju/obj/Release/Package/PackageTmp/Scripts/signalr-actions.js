    ...
    $(function () {
        ...
        function startTimer(certainObject, ifLoadTime) {
            ...
            if (sec > 0) {
                ...
                /*
                var totalSecStart = sec;
                var hoursStart = parseInt(totalSecStart / 3600) % 24;
                var minutesStart = parseInt(totalSecStart / 60) % 60;
                var secondsStart = totalSecStart % 60;

                var resultStart = (hoursStart < 10 ? "0" + hoursStart : hoursStart) + ":" + (minutesStart < 10 ? "0" + minutesStart : minutesStart) + ":" + (secondsStart < 10 ? "0" + secondsStart : secondsStart);

                elem.innerHTML = resultStart;
                */
                if (status == 'OPEN') {
        ...
        stream.client.auctionStatusChanged = function (auctionID) {
